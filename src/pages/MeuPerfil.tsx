...
const MeuPerfil: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-stretch justify-start px-1 py-2 lg:p-0 md:gap-y-2 overflow-x-hidden md:overflow-visible text-slate-800">
            ...
            <section className="w-full lg:w-screen lg:relative lg:left-1/2 lg:right-1/2 lg:-ml-[50vw] lg:-mr-[50vw] pt-0 lg:pt-[88px] pb-0 lg:pb-8 bg-transparent lg:bg-[linear-gradient(180deg,#bdd2ee_0%,#c2dbfe_60%,#eaf4ff_100%)] lg:border-t-[3px] lg:border-[#2563eb] lg:shadow-[0_12px_28px_rgba(0,0,0,0.08)] mb-6">
